...
<body>
	...
	<fieldset>
		...
		<input type="text" name="itt" id="itt" value="java server Pages" required><br>
 		<input type="button" value="전송" onclick="checkForm()"> <!-- button이니까 action실행 안되고 대신 onclick함수가 실행됨.  -->
	</fieldset>
	</form>
<script>
/* 유효성 검사: 데이터가 전송되기 전 폼 입력값이 규칙에 맞게 입력되었는지 확인하는 것
정규 표현식: 특정한 규칙을 가진 문자열의 집합을 표현하는데 사용하는 형식 언어  /=규칙이 정해진 문자가 맞는지.
형식: 
...
*/
	function checkForm() {
		...
		var str = document.frm.itt.value; // 16번 줄 "java server Pages"
